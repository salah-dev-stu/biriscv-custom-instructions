...
// Decode split 8-bit immediate for TERNLOG instruction
// The immediate is split across two fields:
//   - imm8[7:3] in bits[31:27]
//   - imm8[2:0] in bits[14:12]
// TableGen extracts these fields and concatenates them as: {bits[31:27], bits[14:12]}
// So Imm arrives already combined: imm8 = {bits[31:27], bits[14:12]}
static DecodeStatus decodeTernlogImm8(MCInst &Inst, uint32_t Imm,
                                      int64_t Address,
                                      const MCDisassembler *Decoder) {
