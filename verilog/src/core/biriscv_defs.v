...
`define ALU_CSEL                                5'b01100
`define ALU_BREV                                5'b01101
`define ALU_MADD                                5'b01110
`define ALU_TERNLOG                             5'b01111
`define ALU_CMOV                                5'b10000
`define ALU_SAD                                 5'b10001
...
// Format: csel rd, rs1, rs2, rs3
// Operation: rd = (rs3 == 0) ? rs1 : rs2
// Encoding (R4-type): rs3[31:27], funct2[26:25]=00, rs2[24:20], rs1[19:15], funct3[14:12]=000, rd[11:7], opcode[6:0]=0x7B
`define INST_CSEL 32'h7b
`define INST_CSEL_MASK 32'h0600707f

// brev (Bit Reverse)
// Format: brev rd, rs1
// Operation: rd[i] = rs1[31-i] for i in 0..31 (reverse all bits)
// Encoding (R-type): funct7[31:25]=0010000, rs2[24:20]=00000, rs1[19:15], funct3[14:12]=100, rd[11:7], opcode[6:0]=0x7B (custom-3)
`define INST_BREV 32'h2000407b
`define INST_BREV_MASK 32'hfe00707f

// madd (Multiply-Add)
// Format: madd rd, rs1, rs2, rs3
// Operation: rd = (rs1 × rs2) + rs3 (lower 32 bits of result)
// Encoding (R4-type): rs3[31:27], funct2[26:25]=01, rs2[24:20], rs1[19:15], funct3[14:12]=000, rd[11:7], opcode[6:0]=0x7B (custom-3)
`define INST_MADD 32'h0200007b
`define INST_MADD_MASK 32'h0600707f

// ternlog (Bitwise Ternary Logic)
// Format: ternlog rd, rs1, rs2, rs3, imm8
// Operation: For each bit i: index={rs1[i],rs2[i],rs3[i]}, rd[i]=imm8[index] (3-input LUT, 256 possible functions)
// Encoding (R4-type with split imm): imm8[7:3][31:27], funct2[26:25]=10, rs2[24:20], rs1[19:15], imm8[2:0][14:12], rd[11:7], opcode[6:0]=0x7B (custom-3)
`define INST_TERNLOG 32'h0400007b
`define INST_TERNLOG_MASK 32'h0600007f

// cmov (Conditional Move)
// Format: cmov rd, rs1, rs2, rs3
// Operation: rd = (rs3 != 0) ? rs1 : rs2  (move rs1 to rd if rs3 is non-zero, else move rs2)
// Encoding (R4-type): rs3[31:27], funct2[26:25]=11, rs2[24:20], rs1[19:15], funct3[14:12]=001, rd[11:7], opcode[6:0]=0x7B (custom-3)
// Note: Similar to CSEL but with different funct3 for explicit conditional move semantic
`define INST_CMOV 32'h0600107b
`define INST_CMOV_MASK 32'h0600707f
...
// Encoding (R4-type): rs3[31:27], funct2[26:25]=11, rs2[24:20], rs1[19:15], funct3[14:12]=010, rd[11:7], opcode[6:0]=0x7B (custom-3)
// Computes sum of 4 absolute differences between packed bytes, accumulated into rs3
`define INST_SAD 32'h0600207b
`define INST_SAD_MASK 32'h0600707f
